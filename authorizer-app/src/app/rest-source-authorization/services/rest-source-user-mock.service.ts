...
export class RestSourceUserMockService {
  ...
  registerUser(registrationCreateRequest: RegistrationCreateRequest): Observable<RegistrationResponse> {
    const registrationResponse = {
      token: '9876543210',
      secret: registrationCreateRequest.persistent ? '123456789' : undefined,  // only defined if the registration is persistent
      userId: registrationCreateRequest.userId,
      authEndpointUrl: registrationCreateRequest.persistent ? undefined : 'https://www.google.com',  // only defined if the registration is not persistent
      expiresAt: '123456789',
