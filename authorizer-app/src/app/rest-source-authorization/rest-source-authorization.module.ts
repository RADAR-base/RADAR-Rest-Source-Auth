...
// import {RestSourceUserListComponent} from './components/subjects-list/rest-source-user-list.component';
...
import {RestSourceAuthorizationRoutingModule} from './rest-source-authorization-routing.module';
import {RestSourceUserService} from './services/rest-source-user.service';
import { RestSourceUserListComponent} from './components/subjects-list/rest-source-user-list.component';
...
@NgModule({
  ...
  imports: [
    ...
    RestSourceAuthorizationRoutingModule,
  ],
  providers: [
...
export class RestSourceAuthorizationModule {}
